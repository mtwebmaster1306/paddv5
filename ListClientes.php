                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="alineado">
                                                    <label class="custom-switch mt-2" data-toggle="tooltip" title="<?php echo $cliente['estado'] == 1 ? 'Desactivar cliente' : 'Activar cliente'; ?>">
                                                        <input type="checkbox" name="custom-switch-checkbox-<?php echo $cliente['id_cliente']; ?>" class="custom-switch-input estado-switch" data-id="<?php echo $cliente['id_cliente']; ?>" data-tipo="cliente" <?php echo $cliente['estado'] == 1 ? 'checked' : ''; ?>>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger micono" href="#" data-toggle="tooltip" title="Eliminar Cliente"><i class="fas fa-trash-alt "></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
