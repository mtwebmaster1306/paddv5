...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    ...
    if ($resultado === true) {
        ...
        echo json_encode(['success' => true, 'message' => 'Soporte eliminado con éxito']);
    } else {
        error_log("Error al eliminar el Soporte. Detalles: " . json_encode($resultado));
        echo json_encode(['success' => false, 'message' => 'Error al eliminar el Soporte', 'details' => $resultado]);
    }
} else {
