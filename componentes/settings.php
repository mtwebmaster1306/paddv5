<div class="settingSidebar">
          ...
          <div class="settingSidebar-body ps-container ps-theme-default">
            <div class=" fade show active">
              <div class="setting-panel-header">Panel Opciones
              </div>
              ...
              <div class="p-15 border-bottom">
                <h6 class="font-medium m-b-10">Color Barra Lateral</h6>
              ...
              <div class="p-15 border-bottom">
                <h6 class="font-medium m-b-10">Color Barra Superior</h6>
              ...
              <div class="p-15 border-bottom">
                <div class="theme-setting-options">
                  <label class="m-b-0">
                    ...
                    <span class="custom-switch-indicator"></span>
                    <span class="control-label p-l-10">Cabecera Fija</span>
                  </label>
                </div>
              </div>
